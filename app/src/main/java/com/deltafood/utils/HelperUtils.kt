...
import com.deltafood.MainApplication
...
fun getDate(date: String): Date? {
    ...
    try {
        newDate = dateFormat.parse(date)
        formattedString = SimpleDateFormat("dd/MM/yyyy", Locale.getDefault()).format(newDate!!)
        newDate = SimpleDateFormat("dd/MM/yyyy", Locale.getDefault()).parse(formattedString)
    } catch (e: Exception) {
        ////println(e.message)
    }
    return newDate
